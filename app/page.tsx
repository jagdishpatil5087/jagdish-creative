...
export default function CreateCard() {
  ...
  return (
    // 1. Background: Soft, Dreamy Gradient (Pink -> Peach -> Lavender)
    <div className="min-h-screen relative flex flex-col items-center justify-center overflow-hidden bg-gradient-to-tr from-[#ff9a9e] via-[#fad0c4] to-[#fbc2eb] bg-[length:400%_400%] animate-gradient-move gap-8">
      {/* ---------------------------------------------------------
